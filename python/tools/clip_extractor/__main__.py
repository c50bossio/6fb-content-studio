...
def main() -> None:
    ...
    p_reframe.add_argument("--format", default="9x16", choices=["9x16", "1x1", "split", "auto"], help="Output format")
    ...
    p_analyze.add_argument("--format", default="9x16", choices=["9x16", "1x1", "split", "auto"], help="Output format")
    ...
    p_render.add_argument("--format", default="9x16", choices=["9x16", "1x1", "split", "auto"], help="Output format")
    ...
    p_batch.add_argument("--format", default="9x16", choices=["9x16", "1x1", "split", "auto"], help="Output format")

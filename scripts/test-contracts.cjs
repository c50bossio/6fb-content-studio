...
assert.match(smartTrendService, /qualifiedLiveIdeas[\s\S]*?\? dedupeTrendIdeas\(\[\.\.\.qualifiedLiveIdeas, \.\.\.plannedIdeas\]/, 'Only qualified live or planned signals may enter the picker');

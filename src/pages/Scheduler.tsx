  ...
  return (
    <button onClick={onClick}
      ...
      <div className="flex items-center gap-1.5 px-1.5 py-1"
        ...
        {post.thumbnailPath && (
          <img src={toLocalFileUrl(post.thumbnailPath)} alt=""
                    ...
                    {dayPosts.map(post => {
                      ...
                      return (
                        <button key={post.id} onClick={() => setSelectedPost(post)}
                          ...
                          {post.thumbnailPath ? (
                            <img src={toLocalFileUrl(post.thumbnailPath)} alt="" className="w-10 h-14 rounded-lg object-cover shrink-0 border border-[#222]" />
                          ) : (
